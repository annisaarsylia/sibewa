        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">Dashboard</li>
              ...
              <li class="menu-header">Beasiswa.id</li>
              <li class="nav-item dropdown">
      ...
      <!-- Main Content -->
       <div class="main-content">
        <section class="section">
          ...
          <div class="card">
            <form class="needs-validation" novalidate=""  method="POST" action="{{ route('beasiswa.update', $data->id) }}">
              @csrf
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required=""  name="nama" value="{{$data->nama}}" id="nama">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required=""  name="penyelenggara" value="{{$data->penyelenggara}}" id="penyelenggara">
                  <div class="invalid-feedback">
                    Wajib di isi!
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="date" name="deadline" id="deadline" required="" value="{{$data->deadline}}" class="form-control">
                  <div class="invalid-feedback">
                    Wajib di isi!
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required=""  name="sasaran" value="{{$data->sasaran}}" id="sasaran">
                  <div class="invalid-feedback">
                    Wajib di isi!
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required=""  name="ips" value="{{$data->ips}}" id="ips">
                  <div class="invalid-feedback">
                    Wajib di isi!
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required="" name="booklet" value="{{$data->booklet}}" id="booklet">
                  <div class="invalid-feedback">
                    Wajib di isi!
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required="" name="detail" value="{{$data->detail}}" id="detail">
                  <div class="invalid-feedback">
                    Wajib di isi!
                  </div>
                </div>
                    <div class="form-group">
                      <label>Poster</label>
                      <input type="file" class="form-control" value="{{$data->gambar}}">
                    </div>
              </div>
